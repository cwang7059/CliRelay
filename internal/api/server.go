...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware())
	{
		...
		protected.Use(s.mgmt.Middleware(), s.mgmt.RBACMiddleware(), bodyutil.LimitBodyMiddleware(bodyutil.ManagementBodyLimit))
		{
		protected.POST("/auth/logout", s.mgmt.PostPanelLogout)
		protected.GET("/auth/me", s.mgmt.GetPanelMe)
		protected.PUT("/auth/password", s.mgmt.PutPanelPassword)

		protected.GET("/users", s.mgmt.GetPanelUsers)
		protected.POST("/users", s.mgmt.PostPanelUser)
		protected.PUT("/users/:id", s.mgmt.PutPanelUser)
		protected.DELETE("/users/:id", s.mgmt.DeletePanelUser)
		protected.POST("/users/:id/reset-password", s.mgmt.PostPanelUserResetPassword)
		protected.PUT("/users/:id/api-keys", s.mgmt.PutPanelUserAPIKeys)

		protected.GET("/dashboard-summary", s.mgmt.GetDashboardSummary)
		protected.GET("/system-stats", s.mgmt.GetSystemStats)
		protected.GET("/system-stats/ws", func(c *gin.Context) {
			clearServerWriteDeadline(c)
			s.mgmt.SystemStatsWebSocket(c)
		})
		protected.GET("/models", s.mgmt.GetModels)
		protected.GET("/model-configs", s.mgmt.GetModelConfigs)
		protected.POST("/model-configs", s.mgmt.PostModelConfig)
		protected.PUT("/model-configs/*id", s.mgmt.PutModelConfig)
		protected.DELETE("/model-configs/*id", s.mgmt.DeleteModelConfig)
		protected.GET("/model-owner-presets", s.mgmt.GetModelOwnerPresets)
		protected.PUT("/model-owner-presets", s.mgmt.PutModelOwnerPresets)
		protected.GET("/model-openrouter-sync", s.mgmt.GetOpenRouterModelSync)
		protected.PUT("/model-openrouter-sync", s.mgmt.PutOpenRouterModelSync)
		protected.POST("/model-openrouter-sync/run", s.mgmt.PostOpenRouterModelSyncRun)
		protected.GET("/channel-groups", s.mgmt.GetChannelGroups)
		protected.GET("/ccswitch-import-configs", s.mgmt.GetCcSwitchImportConfigs)
		protected.PUT("/ccswitch-import-configs", s.mgmt.PutCcSwitchImportConfigs)
		protected.GET("/routing-config", s.mgmt.GetRoutingConfig)
		protected.PUT("/routing-config", s.mgmt.PutRoutingConfig)
		protected.GET("/identity-fingerprint", s.mgmt.GetIdentityFingerprint)
		protected.PUT("/identity-fingerprint", s.mgmt.PutIdentityFingerprint)
		protected.GET("/model-pricing", s.mgmt.GetModelPricing)
		protected.PUT("/model-pricing", s.mgmt.PutModelPricing)
		protected.GET("/usage", s.mgmt.GetUsageStatistics)
		protected.GET("/usage/export", s.mgmt.ExportUsageStatistics)
		protected.POST("/usage/import", s.mgmt.ImportUsageStatistics)
		protected.GET("/usage/logs", s.mgmt.GetUsageLogs)
		protected.DELETE("/usage/logs", s.mgmt.DeleteUsageLogs)
		protected.GET("/usage/logs/:id/content", s.mgmt.GetLogContent)
		protected.GET("/usage/auth-file-group-trend", s.mgmt.GetAuthFileGroupTrend)
		protected.GET("/usage/auth-file-trend", s.mgmt.GetAuthFileTrend)
		protected.POST("/usage/auth-file-quota-snapshot", s.mgmt.PostAuthFileQuotaSnapshot)
		protected.GET("/usage/chart-data", s.mgmt.GetUsageChartData)
		protected.GET("/usage/entity-stats", s.mgmt.GetEntityUsageStats)
		protected.GET("/config", s.mgmt.GetConfig)
		protected.PUT("/management-key", s.mgmt.PutManagementSecretKey)
		protected.PATCH("/management-key", s.mgmt.PutManagementSecretKey)
		protected.GET("/config.yaml", s.mgmt.GetConfigYAML)
		protected.PUT("/config.yaml", s.mgmt.PutConfigYAML)
		protected.GET("/latest-version", s.mgmt.GetLatestVersion)
		protected.GET("/update/check", s.mgmt.CheckUpdate)
		protected.GET("/update/current", s.mgmt.GetCurrentUpdateState)
		protected.GET("/update/progress", s.mgmt.GetUpdateProgress)
		protected.POST("/update/apply", s.mgmt.ApplyUpdate)
		protected.GET("/auto-update/enabled", s.mgmt.GetAutoUpdateEnabled)
		protected.PUT("/auto-update/enabled", s.mgmt.PutAutoUpdateEnabled)
		protected.PATCH("/auto-update/enabled", s.mgmt.PutAutoUpdateEnabled)
		protected.GET("/auto-update/channel", s.mgmt.GetAutoUpdateChannel)
		protected.PUT("/auto-update/channel", s.mgmt.PutAutoUpdateChannel)
		protected.PATCH("/auto-update/channel", s.mgmt.PutAutoUpdateChannel)

		protected.GET("/debug", s.mgmt.GetDebug)
		protected.PUT("/debug", s.mgmt.PutDebug)
		protected.PATCH("/debug", s.mgmt.PutDebug)

		protected.GET("/logging-to-file", s.mgmt.GetLoggingToFile)
		protected.PUT("/logging-to-file", s.mgmt.PutLoggingToFile)
		protected.PATCH("/logging-to-file", s.mgmt.PutLoggingToFile)

		protected.GET("/logs-max-total-size-mb", s.mgmt.GetLogsMaxTotalSizeMB)
		protected.PUT("/logs-max-total-size-mb", s.mgmt.PutLogsMaxTotalSizeMB)
		protected.PATCH("/logs-max-total-size-mb", s.mgmt.PutLogsMaxTotalSizeMB)

		protected.GET("/error-logs-max-files", s.mgmt.GetErrorLogsMaxFiles)
		protected.PUT("/error-logs-max-files", s.mgmt.PutErrorLogsMaxFiles)
		protected.PATCH("/error-logs-max-files", s.mgmt.PutErrorLogsMaxFiles)

		protected.GET("/usage-statistics-enabled", s.mgmt.GetUsageStatisticsEnabled)
		protected.PUT("/usage-statistics-enabled", s.mgmt.PutUsageStatisticsEnabled)
		protected.PATCH("/usage-statistics-enabled", s.mgmt.PutUsageStatisticsEnabled)

		protected.GET("/proxy-url", s.mgmt.GetProxyURL)
		protected.PUT("/proxy-url", s.mgmt.PutProxyURL)
		protected.PATCH("/proxy-url", s.mgmt.PutProxyURL)
		protected.DELETE("/proxy-url", s.mgmt.DeleteProxyURL)
		protected.GET("/proxy-pool", s.mgmt.GetProxyPool)
		protected.PUT("/proxy-pool", s.mgmt.PutProxyPool)
		protected.POST("/proxy-pool/check", s.mgmt.PostProxyPoolCheck)

		protected.POST("/api-call", s.mgmt.APICall)

		protected.GET("/quota-exceeded/switch-project", s.mgmt.GetSwitchProject)
		protected.PUT("/quota-exceeded/switch-project", s.mgmt.PutSwitchProject)
		protected.PATCH("/quota-exceeded/switch-project", s.mgmt.PutSwitchProject)

		protected.GET("/quota-exceeded/switch-preview-model", s.mgmt.GetSwitchPreviewModel)
		protected.PUT("/quota-exceeded/switch-preview-model", s.mgmt.PutSwitchPreviewModel)
		protected.PATCH("/quota-exceeded/switch-preview-model", s.mgmt.PutSwitchPreviewModel)
		protected.POST("/quota/reconcile", s.mgmt.PostQuotaReconcile)

		protected.GET("/api-keys", s.mgmt.GetAPIKeys)
		protected.PUT("/api-keys", s.mgmt.PutAPIKeys)
		protected.PATCH("/api-keys", s.mgmt.PatchAPIKeys)
		protected.DELETE("/api-keys", s.mgmt.DeleteAPIKeys)

		protected.GET("/api-key-permission-profiles", s.mgmt.GetAPIKeyPermissionProfiles)
		protected.PUT("/api-key-permission-profiles", s.mgmt.PutAPIKeyPermissionProfiles)

		protected.GET("/api-key-entries", s.mgmt.GetAPIKeyEntries)
		protected.PUT("/api-key-entries", s.mgmt.PutAPIKeyEntries)
		protected.PATCH("/api-key-entries", s.mgmt.PatchAPIKeyEntry)
		protected.DELETE("/api-key-entries", s.mgmt.DeleteAPIKeyEntry)

		protected.GET("/gemini-api-key", s.mgmt.GetGeminiKeys)
		protected.PUT("/gemini-api-key", s.mgmt.PutGeminiKeys)
		protected.PATCH("/gemini-api-key", s.mgmt.PatchGeminiKey)
		protected.DELETE("/gemini-api-key", s.mgmt.DeleteGeminiKey)

		protected.GET("/logs", s.mgmt.GetLogs)
		protected.DELETE("/logs", s.mgmt.DeleteLogs)
		protected.GET("/request-error-logs", s.mgmt.GetRequestErrorLogs)
		protected.GET("/request-error-logs/:name", s.mgmt.DownloadRequestErrorLog)
		protected.GET("/request-log-by-id/:id", s.mgmt.GetRequestLogByID)
		protected.GET("/request-log", s.mgmt.GetRequestLog)
		protected.PUT("/request-log", s.mgmt.PutRequestLog)
		protected.PATCH("/request-log", s.mgmt.PutRequestLog)
		protected.GET("/ws-auth", s.mgmt.GetWebsocketAuth)
		protected.PUT("/ws-auth", s.mgmt.PutWebsocketAuth)
		protected.PATCH("/ws-auth", s.mgmt.PutWebsocketAuth)

		protected.GET("/ampcode", s.mgmt.GetAmpCode)
		protected.GET("/ampcode/upstream-url", s.mgmt.GetAmpUpstreamURL)
		protected.PUT("/ampcode/upstream-url", s.mgmt.PutAmpUpstreamURL)
		protected.PATCH("/ampcode/upstream-url", s.mgmt.PutAmpUpstreamURL)
		protected.DELETE("/ampcode/upstream-url", s.mgmt.DeleteAmpUpstreamURL)
		protected.GET("/ampcode/upstream-api-key", s.mgmt.GetAmpUpstreamAPIKey)
		protected.PUT("/ampcode/upstream-api-key", s.mgmt.PutAmpUpstreamAPIKey)
		protected.PATCH("/ampcode/upstream-api-key", s.mgmt.PutAmpUpstreamAPIKey)
		protected.DELETE("/ampcode/upstream-api-key", s.mgmt.DeleteAmpUpstreamAPIKey)
		protected.GET("/ampcode/restrict-management-to-localhost", s.mgmt.GetAmpRestrictManagementToLocalhost)
		protected.PUT("/ampcode/restrict-management-to-localhost", s.mgmt.PutAmpRestrictManagementToLocalhost)
		protected.PATCH("/ampcode/restrict-management-to-localhost", s.mgmt.PutAmpRestrictManagementToLocalhost)
		protected.GET("/ampcode/model-mappings", s.mgmt.GetAmpModelMappings)
		protected.PUT("/ampcode/model-mappings", s.mgmt.PutAmpModelMappings)
		protected.PATCH("/ampcode/model-mappings", s.mgmt.PatchAmpModelMappings)
		protected.DELETE("/ampcode/model-mappings", s.mgmt.DeleteAmpModelMappings)
		protected.GET("/ampcode/force-model-mappings", s.mgmt.GetAmpForceModelMappings)
		protected.PUT("/ampcode/force-model-mappings", s.mgmt.PutAmpForceModelMappings)
		protected.PATCH("/ampcode/force-model-mappings", s.mgmt.PutAmpForceModelMappings)
		protected.GET("/ampcode/upstream-api-keys", s.mgmt.GetAmpUpstreamAPIKeys)
		protected.PUT("/ampcode/upstream-api-keys", s.mgmt.PutAmpUpstreamAPIKeys)
		protected.PATCH("/ampcode/upstream-api-keys", s.mgmt.PatchAmpUpstreamAPIKeys)
		protected.DELETE("/ampcode/upstream-api-keys", s.mgmt.DeleteAmpUpstreamAPIKeys)

		protected.GET("/request-retry", s.mgmt.GetRequestRetry)
		protected.PUT("/request-retry", s.mgmt.PutRequestRetry)
		protected.PATCH("/request-retry", s.mgmt.PutRequestRetry)
		protected.GET("/max-retry-interval", s.mgmt.GetMaxRetryInterval)
		protected.PUT("/max-retry-interval", s.mgmt.PutMaxRetryInterval)
		protected.PATCH("/max-retry-interval", s.mgmt.PutMaxRetryInterval)

		protected.GET("/force-model-prefix", s.mgmt.GetForceModelPrefix)
		protected.PUT("/force-model-prefix", s.mgmt.PutForceModelPrefix)
		protected.PATCH("/force-model-prefix", s.mgmt.PutForceModelPrefix)

		protected.GET("/routing/strategy", s.mgmt.GetRoutingStrategy)
		protected.PUT("/routing/strategy", s.mgmt.PutRoutingStrategy)
		protected.PATCH("/routing/strategy", s.mgmt.PutRoutingStrategy)

		protected.GET("/claude-api-key", s.mgmt.GetClaudeKeys)
		protected.PUT("/claude-api-key", s.mgmt.PutClaudeKeys)
		protected.PATCH("/claude-api-key", s.mgmt.PatchClaudeKey)
		protected.DELETE("/claude-api-key", s.mgmt.DeleteClaudeKey)

		protected.GET("/bedrock-api-key", s.mgmt.GetBedrockKeys)
		protected.PUT("/bedrock-api-key", s.mgmt.PutBedrockKeys)
		protected.PATCH("/bedrock-api-key", s.mgmt.PatchBedrockKey)
		protected.DELETE("/bedrock-api-key", s.mgmt.DeleteBedrockKey)

		protected.GET("/opencode-go-api-key", s.mgmt.GetOpenCodeGoKeys)
		protected.PUT("/opencode-go-api-key", s.mgmt.PutOpenCodeGoKeys)
		protected.PATCH("/opencode-go-api-key", s.mgmt.PatchOpenCodeGoKey)
		protected.DELETE("/opencode-go-api-key", s.mgmt.DeleteOpenCodeGoKey)

		protected.GET("/codex-api-key", s.mgmt.GetCodexKeys)
		protected.PUT("/codex-api-key", s.mgmt.PutCodexKeys)
		protected.PATCH("/codex-api-key", s.mgmt.PatchCodexKey)
		protected.DELETE("/codex-api-key", s.mgmt.DeleteCodexKey)

		protected.GET("/openai-compatibility", s.mgmt.GetOpenAICompat)
		protected.PUT("/openai-compatibility", s.mgmt.PutOpenAICompat)
		protected.PATCH("/openai-compatibility", s.mgmt.PatchOpenAICompat)
		protected.DELETE("/openai-compatibility", s.mgmt.DeleteOpenAICompat)

		protected.GET("/vertex-api-key", s.mgmt.GetVertexCompatKeys)
		protected.PUT("/vertex-api-key", s.mgmt.PutVertexCompatKeys)
		protected.PATCH("/vertex-api-key", s.mgmt.PatchVertexCompatKey)
		protected.DELETE("/vertex-api-key", s.mgmt.DeleteVertexCompatKey)

		protected.GET("/oauth-excluded-models", s.mgmt.GetOAuthExcludedModels)
		protected.PUT("/oauth-excluded-models", s.mgmt.PutOAuthExcludedModels)
		protected.PATCH("/oauth-excluded-models", s.mgmt.PatchOAuthExcludedModels)
		protected.DELETE("/oauth-excluded-models", s.mgmt.DeleteOAuthExcludedModels)

		protected.GET("/oauth-model-alias", s.mgmt.GetOAuthModelAlias)
		protected.PUT("/oauth-model-alias", s.mgmt.PutOAuthModelAlias)
		protected.PATCH("/oauth-model-alias", s.mgmt.PatchOAuthModelAlias)
		protected.DELETE("/oauth-model-alias", s.mgmt.DeleteOAuthModelAlias)

		protected.GET("/auth-files", s.mgmt.ListAuthFiles)
		protected.GET("/auth-files/models", s.mgmt.GetAuthFileModels)
		protected.GET("/model-definitions/:channel", s.mgmt.GetStaticModelDefinitions)
		protected.GET("/image-generation/channels", s.mgmt.ListImageGenerationChannels)
		protected.POST("/image-generation/test", s.mgmt.PostImageGenerationTest)
		protected.GET("/image-generation/test/:task_id", s.mgmt.GetImageGenerationTestTask)
		protected.GET("/auth-files/download", s.mgmt.DownloadAuthFile)
		protected.POST("/auth-files", s.mgmt.UploadAuthFile)
		protected.DELETE("/auth-files", s.mgmt.DeleteAuthFile)
		protected.POST("/auth-files/recover-401", s.mgmt.RecoverCodex401AuthFile)
		protected.GET("/auth-files/recover-401/credentials", s.mgmt.GetCodex401RecoveryCredentials)
		protected.GET("/auth-recovery/queue", s.mgmt.GetRecoveryQueue)
		protected.GET("/auth-recovery/otp", s.mgmt.FetchOTP)
		protected.PATCH("/auth-files/status", s.mgmt.PatchAuthFileStatus)
		protected.PATCH("/auth-files/fields", s.mgmt.PatchAuthFileFields)
		protected.POST("/vertex/import", s.mgmt.ImportVertexCredential)
		...
		protected.GET("/qwen-auth-url", s.mgmt.RequestQwenToken)
		protected.GET("/kimi-auth-url", s.mgmt.RequestKimiToken)
		protected.GET("/iflow-auth-url", s.mgmt.RequestIFlowToken)
		protected.POST("/iflow-auth-url", s.mgmt.RequestIFlowCookieToken)
